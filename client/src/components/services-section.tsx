...
const ServiceCard = ({ icon, title, description, features }: ServiceCardProps) => {
  ...
  return (
    <div className="bg-light rounded-lg p-8 shadow-sm hover:shadow-md transition duration-300">
      ...
      <ul className="space-y-2 mb-6">
        {features.map((feature, index) => (
          <li key={index} className="flex items-start">
            <svg className="h-5 w-5 text-primary mt-0.5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
