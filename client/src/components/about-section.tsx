...
const AboutSection = () => {
  return (
    <section id="about" className="section-padding bg-gray-50 relative overflow-hidden">
      ...
      <div className="purple-circle-decoration w-[400px] h-[400px] top-[-10%] left-[-15%] opacity-20"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="inline-block bg-primary/10 text-primary font-medium px-4 py-2 rounded-full mb-4">О специалисте</div>
            ...
            <div className="mb-8 space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Сертифицированный специалист Яндекс.Директ</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-primary mr-3" />
                <span className="text-gray-700">Сертифицированный специалист Google Ads</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-primary mr-3" />
                <span className="text-gray-700">Опыт работы более 5 лет</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-primary mr-3" />
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-white rounded-xl p-4 card-shadow text-center">
                ...
                <div className="text-gray-600 text-sm">ниш бизнеса</div>
              </div>
            </div>
            
            <div className="flex flex-wrap gap-3">
              <div className="h-14 w-14 rounded-xl shadow-sm bg-white flex items-center justify-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              />
              <div className="absolute -right-4 -bottom-4 md:-right-8 md:-bottom-8 bg-white p-4 rounded-xl card-shadow max-w-[180px]">
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    <div className="text-sm font-semibold">Google Partner</div>
                    <div className="text-xs text-gray-500">Сертифицированный специалист</div>
                  </div>
                </div>
              </div>
            </div>
