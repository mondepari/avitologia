            ...
            <div className="hidden md:flex items-center ml-auto">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-2">
                  <a href="https://t.me/username" target="_blank" rel="noopener" className="flex items-center justify-center w-8 h-8 bg-primary/20 rounded-full hover:bg-primary/30 transition-all duration-300">
                  ...
                  <a href="https://wa.me/7937343453" target="_blank" rel="noopener" className="flex items-center justify-center w-8 h-8 bg-primary/20 rounded-full hover:bg-primary/30 transition-all duration-300">
                  ...
                  <a href="https://avito.ru/profile" target="_blank" rel="noopener" className="flex items-center justify-center w-8 h-8 bg-primary/20 rounded-full hover:bg-primary/30 transition-all duration-300">
