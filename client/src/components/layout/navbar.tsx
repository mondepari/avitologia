      ...
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 border-b border-gray-100 ${
        ...
        <div className="flex items-center justify-between px-4 py-3 max-w-7xl mx-auto">
            ...
            <div className="flex items-center">
              <Link href="/">
                <div className="flex items-center cursor-pointer">
                  <div className="text-purple-700 font-bold text-2xl mr-3">TF</div>
                </div>
              </Link>
          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            <ContactPopup>
              <button className="bg-purple-100 text-purple-700 flex items-center rounded-full px-4 py-1.5 hover:bg-purple-200 transition-all">
                ...
                <span className="font-medium text-sm whitespace-nowrap">+7(937) 343-45-43</span>
              </button>
            </ContactPopup>
          </div>
          ...
          <div className="lg:hidden ml-auto flex items-center">
            ...
            <ContactPopup>
              <button className="bg-purple-100 text-purple-700 flex items-center rounded-full p-2 hover:bg-purple-200 transition-all mr-2">
