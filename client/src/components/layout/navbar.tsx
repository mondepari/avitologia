        ...
        <div className="container py-2 px-4">
          <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-2">
                  <a href="https://t.me/username" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 bg-primary/10 rounded-full hover:bg-primary/20 transition-all">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#6200EE]">
                  ...
                  <a href="https://wa.me/7937343453" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 bg-primary/10 rounded-full hover:bg-primary/20 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[#6200EE]">
                  ...
                  <a href="https://avito.ru/profile" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 bg-primary/10 rounded-full hover:bg-primary/20 transition-all">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="#6200EE" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContactPopup>
                  <button className="bg-primary/10 text-[#6200EE] flex items-center rounded-full px-4 py-1.5 hover:bg-primary/20 transition-all">
            ...
            <div className="md:hidden ml-auto mr-2">
              <ContactPopup>
                <button className="bg-primary/10 text-[#6200EE] flex items-center rounded-full p-2 hover:bg-primary/20 transition-all">
