  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 border-b border-gray-100 ${
        scrolled ? 'bg-background shadow-sm' : 'bg-background'
      }`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-4 text-xs font-medium text-foreground/70 hidden lg:block">
                <p className="text-gray-600">Сертифицированный специалист по<br />Яндекс.Директ</p>
              </div>
            </div>
            
            <div className="hidden md:flex items-center ml-auto">
              <div className="text-foreground/80 flex items-center mr-4">
                <MapPin className="h-4 w-4 mr-1 text-[#6200EE]" />
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-1">
                  <a href="https://t.me/username" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 text-[#6200EE] hover:opacity-80 transition-opacity">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#6200EE]">
                  ...
                  <a href="https://wa.me/7937343453" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 text-[#6200EE] hover:opacity-80 transition-opacity">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-[#6200EE]">
                  ...
                  <a href="https://avito.ru/profile" target="_blank" rel="noopener" 
                    className="flex items-center justify-center w-7 h-7 text-[#6200EE] hover:opacity-80 transition-opacity">
                    <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor" className="text-[#6200EE]" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContactPopup>
                  <button className="text-[#6200EE] flex items-center px-2 py-1 hover:opacity-80 transition-opacity">
            ...
            <div className="md:hidden ml-auto mr-2">
              <ContactPopup>
                <button className="text-[#6200EE] flex items-center p-1 hover:opacity-80 transition-opacity">
            ...
            <button 
              ...
              className="focus:outline-none text-[#6200EE] p-2 flex items-center justify-center"
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center">
            <div className="font-bold text-xl text-[#6200EE]">TF</div>
          </div>
          <button 
            onClick={toggleSideMenu}
