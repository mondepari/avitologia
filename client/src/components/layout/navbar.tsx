...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Side Menu */}
      <div 
        className={`fixed top-0 right-0 h-full bg-background z-50 w-[300px] shadow-xl transition-transform duration-300 ease-in-out transform ${
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <button 
                ...
                className="w-full text-left px-3 py-2 hover:bg-gray-800 rounded-lg flex items-center justify-between text-white"
              >
            ...
            <div className="pt-4 border-t border-gray-700">
              <h3 className="font-semibold text-sm text-gray-400 mb-3">ПОЛЕЗНЫЕ ССЫЛКИ</h3>
              <div className="space-y-2">
                <a href="#" className="block px-3 py-2 hover:bg-gray-800 rounded-lg text-white text-sm flex items-center">
                  <div className="w-5 h-5 flex items-center justify-center mr-2 bg-gray-800 rounded">
            ...
            <div className="pt-4 border-t border-gray-700">
              <h3 className="font-semibold text-sm text-gray-400 mb-3">КОНТАКТЫ</h3>
              <div className="space-y-2">
                <div className="flex items-start px-3 py-2">
                  <MapPin className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-sm text-white">Удаленно по всей России</span>
                </div>
                <div className="flex items-start px-3 py-2">
                  <Phone className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-sm text-white">+7(937) 343-45-43</span>
                </div>
                <div className="flex items-start px-3 py-2">
                  <Mail className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-sm text-white">olegbusiness@mail.ru</span>
                </div>
                
                <div className="flex items-center space-x-2 px-3 py-2">
                  <span className="text-xs text-gray-400">Соц. сети:</span>
                  <div className="flex space-x-2">
                    ...
                    <a href="https://avito.ru/profile" target="_blank" className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-primary" xmlns="http://www.w3.org/2000/svg">
